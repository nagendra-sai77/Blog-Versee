  ...
  return (
    ...
    <div className="flex flex-col  items-center mt-10 gap-5">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col border-2 border-black lg-w-[90%] sm-w-full md:w-1/3  p-10 gap-5 rounded-2xl ">
            ...
            <Link to="/" className=" text-center font-semibold text-gray-600 hover:bg-blue-500 border-2 rounded-2xl bg-blue-300 lg-w-[90%] sm-w-full md:w-[95%] flex justify-center">    <ArrowLeftToLine />
